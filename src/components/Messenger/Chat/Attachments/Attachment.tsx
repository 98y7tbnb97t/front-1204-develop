    ...
    return (
        <>
            {(attachment.type === 'image' || attachment.type === 'video') &&
                <div onClick={() => setM(true)} className={["h-[150px] basis-1/2 md:basis-1/3 flex-grow mb-2 [&>div]:hover:flex relative hover:before:bg-gray-800 hover:before:opacity-80 before:absolute hover:before:w-[calc(100%-8px)] cursor-pointer hover:before:h-full",className].join(' ')}>
