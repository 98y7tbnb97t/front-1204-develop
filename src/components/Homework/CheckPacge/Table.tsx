...
const Table: FC<TableProps> = ({table, homework}) => {
    ...
    const {
        ...
        transferToOnlineLessonText: ITranslateItemString
    } = translations.groups

    return (
        <div className="p-5 w-full">
            <button className='bg-gradient-button text-lg px-3 py-3 rounded-full w-full mb-5' onClick={()=> void toOnlineHandler()}>{transferToOnlineLessonText[language]}</button>
