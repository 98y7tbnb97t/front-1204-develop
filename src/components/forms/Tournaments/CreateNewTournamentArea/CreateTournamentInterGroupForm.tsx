...
const CreateTournamentInterGroupForm = ({ groupId }: any) => {
  ...
  const onSubmit = async (data: Form) => {
    ...
    navigate(`/Tournament/${groupId}/intergroup/finish`);
  };

  return (
    <div className="p-5  overflow-hidden border-[#B7975A] rounded-3xl ml-6 mt-5 border">
      <h3 className="text-center text-[44px] ">Создать новый Межгрупповой турнир</h3>
...
export default CreateTournamentInterGroupForm;
