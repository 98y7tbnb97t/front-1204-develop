...
const CreateTournamentSwissForm = ({ groupId }: any) => {
  ...
  const onSubmit = async (data: Form) => {
    ...
    navigate(`/Tournament/${groupId}/Swiss/tostart`);
  };

  return (
    <div className='bg-[#eaeaea] pb-5 pr-5 shadow-2xl overflow-auto rounded-[30px] mt-2 w-[calc(100%-1%)] '>
    <div className="p-5   border-[#B7975A] rounded-3xl ml-6 mt-5 border">
      <h3 className="text-center text-[44px] ">Создать новый турнир по Швейцарской системе</h3>
      <p className='text-gray-400 text-xl text-center'>Наши советы по организации мероприятий</p>
      ...
      <div className="border-t my-3">
        ...
        <div className="grid grid-cols-2 gap-y-5 gap-x-5 ">
          ...
          <div>
            <Input
              className={
                'font-bold text-gray-700 placeholder:font-normal mt-5 rounded-3xl'
              }
              wrapperClass="w-full"
              type="text"
          ...
          <div className='max-w-[500px]'>
            <div className="flex items-center ">
              <TournamentSwitch
                ...
                onChange={handleTournamentSwitchRank}
              />
              <h2 className="ml-6 font-bold text-lg text-pink-500 ">Должно быть, сыграли свою последнюю швейцарскую игру</h2>
            </div>
            <p className="my-1 text-gray-400 text-sm">
            Позвольте игрокам присоединиться, только если они сыграли свою последнюю швейцарскую игру. Если им не удастся появиться в недавнем швейцарском мероприятии, они не смогут войти в ваше. Это приводит к лучшему швейцарскому опыту для игроков, которые действительно появляются.
            </p>
          </div>
                  ...
                  <div className="flex flex-wrap mt-10">
                    <div className="w-[35vw]">
                      <div className="flex items-center  ">
                        ...
                        Должно быть, сыграли свою последнюю швейцарскую игру
                        </h2>
                      </div>
                      <p className="my-1 text-gray-400 text-sm">
                      Позвольте игрокам присоединиться, только если они сыграли свою последнюю швейцарскую игру. Если им не удастся появиться в недавнем швейцарском мероприятии, они не смогут войти в ваше. Это приводит к лучшему швейцарскому опыту для игроков, которые действительно появляются.
...
export default CreateTournamentSwissForm;
