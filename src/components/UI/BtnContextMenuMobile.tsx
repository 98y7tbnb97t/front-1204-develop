        ...
        <>
            {btnType === "group" && <div
                ...
                <div
                    ...
                    <div className='text-[rgb(53, 53, 53) text-xl text-center mb-3'>{createAnonimGroupText[language]}</div>
                    <div className='flex flex-col gap-3'>
                        <label>Название:</label>
                        <input type='text' className='outline-none border rounded-[50px] px-3 py-1 border-gray-400'/>
                        <label>{descriptionTitleText[language]}:</label>
                        <input type='text' className='outline-none border rounded-[50px] px-3 py-1  border-gray-400'/>
                        <button
                                className='bg-black text-white p-2 rounded-[50px]'>
                            {createGroupText[language]}
                        </button>
                    </div>
                    <div
                        ...
                        <div
                            ...
                            <div className='flex flex-col gap-3'>
                                <div className='flex justify-between'>
                                    ...
                                    <input type='checkbox' className="accent-slate-950 w-5 h-5"/>
                                </div>
                                <div className='flex justify-between'>
                                    <div className='flex gap-2'>
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <input type='checkbox' checked className="accent-slate-950 w-5 h-5"/>
                                </div>
                                <div className='flex justify-between'>
                                    <div className='flex gap-2'>
