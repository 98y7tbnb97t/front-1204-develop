    ...
    return (
        <>
            <Modal active={modal} setActive={setModal} className='items-center max-w-[600px] !rounded-3xl border-2 border-[#8A6E3E]'>
                <h1 className='text-sm md:text-2xl font-bold tracking-wider text-gray-800 capitalize '>Edit Titlte</h1>
                <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className='bg-white container mx-auto flex flex-col p-1  md:p-5 max-w-2xl'>
