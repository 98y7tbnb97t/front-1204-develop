...
const MyNotificationsText: FC = () => {
  ...
  useEffect(() => {
    if (myNotificationsText) {
      setText(myNotificationsText);
    }
  }, [myNotificationsText]);

  const handleSave = () => {
    void dispatch(editInfoText({ field: EInfoTextFields.myNotificationsText, text }))
    setIsModalOpen(true);
  };
...
export default MyNotificationsText;