...
const ChessBoardTournament: FC<ChessBoardProps> = ({
  moveMode,
  globalMode,
  clear,
  setClear,
  ...
  return (
    <div className={''}>
      <div
        ...
        } aspect-square h-[calc(100%-50px)]`}
      >
        <canvas id="primary_canvas" className=" aspect-square"></canvas>
        <canvas id="drawing_canvas" className=" aspect-square"></canvas>
        <Chessboard
...
export default ChessBoardTournament;
